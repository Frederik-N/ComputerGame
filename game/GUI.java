...
public class GUI {
	...
	/**
	 * Applies the settings. That is, updates the components in the Settings menu to reflect the actual state.
	 */
	 ...
	 */
	public JFrame createOptionsMenu(){
...
/**
 * The JPanel which actually handles drawing the state of the game.
 * An instance of WorldPanel is aggregated by GUI.
 * 
 * @author Nikolaj Ignatieff Schwartzbach
 * @version 1.0.0
 */
class WorldPanel extends JPanel {
    ...
    /** Different strokes (thick is for capital cities) */
